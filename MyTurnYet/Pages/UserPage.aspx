<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserPage.aspx.cs" EnableEventValidation="true" Inherits="MyTurnYet.Pages.UserPage" %>
                    ...
                    <div class="row">
                        <div class="col-md-12 align-self-start">
                            <div class="booking-cta">
                                <asp:Button runat="server" BorderStyle="Solid" OnClick="logut_btn_Click" ID="logut_btn" BorderWidth="2" BackColor="Red" CssClass="col-lg-12 pull-right" Text="Logga Ut" />
                     ...
                     <asp:Image ID="notfound_img" CssClass="img-responsive" runat="server" />
                        ...
                        <%--Bekräftade barn Form--%>
                        <div class="col align-self-start col-lg-6">
                            <%--<div class="booking-form">--%>

                            <asp:Panel runat="server" ID="Panal_A_Not_Found" Visible="false">
                                <div class="col-md-12 text-center">
                     ...
                     <asp:Image ID="Image1" CssClass="img-responsive" runat="server" />
                            ...
                            <asp:Panel runat="server" ID="Panal_A_Found" Visible="false">
                                <div class="col-md-12">
                            ...
                            <div class="egen">
                                <asp:GridView ID="GridView2" CssClass="grid" runat="server" AutoGenerateColumns="false"
